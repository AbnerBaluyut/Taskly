      ...
      builder: (context, state) {
        return Padding(
          ...
          child: Column(
            ...
            children: [
              GestureDetector(
                onTap: (state is RegisterLoadingState) ? null : () {
                  setState(() {
                ...
                child: ListTile(
                  ...
                  leading: AnimatedSwitcher(
                    ...
                    child: Container(
                      key: UniqueKey(),
                      child: _isChecked ? Icon(Icons.check_box, color: (state is RegisterLoadingState) ? Colors.grey : Colors.blue) : Icon(Icons.check_box_outline_blank, color: Colors.grey),
                    ),
                  ),
                  dense: true,
              ...
              SizedBox(
                ...
                child: CommonElevatedButton(
                  ...
                  onButtonPressed: (state is RegisterLoadingState) || !_isChecked ? null : widget.onTapRegister,
                  text: "Register",
                  fontSize: 16.0,
